...
#ifndef FLEET_MSGS__MSG__DETAIL__HEARTBEAT__FUNCTIONS_H_
#define FLEET_MSGS__MSG__DETAIL__HEARTBEAT__FUNCTIONS_H_
 ...
 * )) before or use
 * fleet_msgs__msg__Heartbeat__create()
 ...
 * calls
 * fleet_msgs__msg__Heartbeat__init().
...
/**
 * It calls
 * fleet_msgs__msg__Heartbeat__fini()
 ...
 * fleet_msgs__msg__Heartbeat__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * fleet_msgs__msg__Heartbeat__Sequence__fini()
 * on the array,
...
#endif  // FLEET_MSGS__MSG__DETAIL__HEARTBEAT__FUNCTIONS_H_
