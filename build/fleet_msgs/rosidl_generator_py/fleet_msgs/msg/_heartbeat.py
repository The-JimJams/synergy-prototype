...
class Metaclass_Heartbeat(rosidl_pycommon.interface_base_classes.MessageTypeSupportMeta):
    ...
    class HeartbeatConstants(typing.TypedDict):
        pass

    __constants: HeartbeatConstants = {
    }
...
class Heartbeat(rosidl_pycommon.interface_base_classes.BaseMessage, metaclass=Metaclass_Heartbeat):
