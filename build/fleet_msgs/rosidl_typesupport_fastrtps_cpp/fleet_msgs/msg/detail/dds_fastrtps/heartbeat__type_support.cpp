...
#include "fleet_msgs/msg/detail/heartbeat__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const fleet_msgs::msg::Heartbeat & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  fleet_msgs::msg::Heartbeat & ros_message)
{
  // Member: robot_id
  cdr >> ros_message.robot_id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fleet_msgs::msg::Heartbeat;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const fleet_msgs::msg::Heartbeat *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<fleet_msgs::msg::Heartbeat *>(
    untyped_ros_message);
...
{
  return &fleet_msgs::msg::typesupport_fastrtps_cpp::_Heartbeat__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, fleet_msgs, msg, Heartbeat)() {
  return &fleet_msgs::msg::typesupport_fastrtps_cpp::_Heartbeat__handle;
}
