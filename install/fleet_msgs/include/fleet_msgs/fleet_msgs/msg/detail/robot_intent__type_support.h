...
#ifndef FLEET_MSGS__MSG__DETAIL__ROBOT_INTENT__TYPE_SUPPORT_H_
#define FLEET_MSGS__MSG__DETAIL__ROBOT_INTENT__TYPE_SUPPORT_H_
...
#endif  // FLEET_MSGS__MSG__DETAIL__ROBOT_INTENT__TYPE_SUPPORT_H_
