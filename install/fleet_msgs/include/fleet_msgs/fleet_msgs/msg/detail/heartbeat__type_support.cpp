...
{
  new (message_memory) fleet_msgs::msg::Heartbeat(_init);
}

void Heartbeat_fini_function(void * message_memory)
{
  auto typed_message = static_cast<fleet_msgs::msg::Heartbeat *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Heartbeat_message_member_array[2] = {
  {
    ...
    offsetof(fleet_msgs::msg::Heartbeat, robot_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(fleet_msgs::msg::Heartbeat, timestamp),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Heartbeat_message_members = {
  ...
  2,  // number of fields
  sizeof(fleet_msgs::msg::Heartbeat),
...
get_message_type_support_handle<fleet_msgs::msg::Heartbeat>()
{
  return &::fleet_msgs::msg::rosidl_typesupport_introspection_cpp::Heartbeat_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, fleet_msgs, msg, Heartbeat)() {
  return &::fleet_msgs::msg::rosidl_typesupport_introspection_cpp::Heartbeat_message_type_support_handle;
}
