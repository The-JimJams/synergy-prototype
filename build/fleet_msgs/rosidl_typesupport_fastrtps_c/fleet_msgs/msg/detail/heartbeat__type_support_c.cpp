...
#include "fleet_msgs/msg/detail/heartbeat__rosidl_typesupport_fastrtps_c.h"
...
using _Heartbeat__ros_msg_type = fleet_msgs__msg__Heartbeat;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fleet_msgs
bool cdr_serialize_fleet_msgs__msg__Heartbeat(
  const fleet_msgs__msg__Heartbeat * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fleet_msgs
bool cdr_deserialize_fleet_msgs__msg__Heartbeat(
  eprosima::fastcdr::Cdr & cdr,
  fleet_msgs__msg__Heartbeat * ros_message)
{
  // Field name: robot_id
  {
    std::string tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fleet_msgs
size_t get_serialized_size_fleet_msgs__msg__Heartbeat(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fleet_msgs
size_t max_serialized_size_fleet_msgs__msg__Heartbeat(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = fleet_msgs__msg__Heartbeat;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fleet_msgs
bool cdr_serialize_key_fleet_msgs__msg__Heartbeat(
  const fleet_msgs__msg__Heartbeat * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: robot_id
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fleet_msgs
size_t get_serialized_size_key_fleet_msgs__msg__Heartbeat(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Heartbeat__ros_msg_type * ros_message = static_cast<const _Heartbeat__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_fleet_msgs
size_t max_serialized_size_key_fleet_msgs__msg__Heartbeat(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const fleet_msgs__msg__Heartbeat * ros_message = static_cast<const fleet_msgs__msg__Heartbeat *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_fleet_msgs__msg__Heartbeat(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  fleet_msgs__msg__Heartbeat * ros_message = static_cast<fleet_msgs__msg__Heartbeat *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_fleet_msgs__msg__Heartbeat(cdr, ros_message);
}

static uint32_t _Heartbeat__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_fleet_msgs__msg__Heartbeat(
...
static size_t _Heartbeat__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_fleet_msgs__msg__Heartbeat(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, fleet_msgs, msg, Heartbeat)() {
